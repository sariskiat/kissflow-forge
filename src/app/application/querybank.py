...
CLI: ``python3 -m app.application.querybank [--sweep S] [--observable O] [--count]``
"""
...
FIELD_TYPES: tuple[FieldType, ...] = (
    ...
    FieldType(
        "Sequence number", "sequence-number", "advanced", "parity", _NO_SEQ_NO_SMART, no_event=True
    ),
...
def _module_semantic_queries() -> list[Query]:
    items: tuple[tuple[str, str, str], ...] = (
        (
            "boards",
            "process-vs-board",
            "When should an app be a board instead of a process? Give the decision rule.",
        ),
        (
            "boards",
            "board-statuses",
            "How do board statuses and columns work, and how do items move between them?",
        ),
        (
            "boards",
            "board-workflow",
            "Can a board have an approval workflow like a process? What are the limits?",
        ),
        (
            "dataform",
            "process-vs-dataform",
        ...
        (
            ...
            "How do I connect a dataform to a process using a page, so process items can read and write dataform records?",
        ),
        (
            "dataform",
            "dataform-views",
        ...
        (
            "boards",
            "three-way",
            "I have a request-handling use case: how do I decide between process, board, and dataform?",
        ),
    )
    return [
        Query(
...
def _role_queries() -> list[Query]:
    ...
    fixed: tuple[tuple[str, str, str, str], ...] = (
        (
            ...
            GRAPH_DIFF,
            "new AppRole record (account-level route; engine has no create path — prize capture)",
        ),
        (
            "delete",
        ...
        (
            "tier-semantics",
            "What exactly can a role do at each permission level: No access, Read-only, Edit, Manage?",
            ANSWER,
        ...
        (
            "role-best-practice",
            "What roles should a typical approval app define, and with which permissions?",
            ANSWER,
