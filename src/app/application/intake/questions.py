"""app.application.intake.questions — the grilling script: what to ask a Thai business owner to fill in
...
from app.application.intake.schema import AppSpec, _gap_dimensions
...
_Q5: tuple[Question, ...] = (
    Question(
        ...
        example=("เช่น ถ้า 'ตรวจสอบคุณภาพ' ไม่ผ่าน ต้องย้อนกลับไปขั้น 'ซ่อม' ใหม่ จนกว่าจะติ๊กช่อง 'ผ่านคุณภาพแล้ว'"),
        follow_ups=(
...
_Q10: tuple[Question, ...] = (
    Question(
        ...
        example=("เช่น หัวหน้าฝ่ายซ่อมบำรุงอยากเห็น: จำนวนงานค้างทั้งหมด, งานที่เกิน SLA, ปุ่มมอบหมายงานใหม่"),
