...
ROWS: tuple[CoverageRow, ...] = (
    ...
    CoverageRow(
        "page-layout", "page container layout (flex direction/gap/padding)", Bucket.CAPTURED_LIVE
    ),
    CoverageRow("page-typography", "page text via label widgets", Bucket.CAPTURED_LIVE),
    CoverageRow(
        "page-colour-styling", "page colour via Style (raw hex or token ref)", Bucket.CAPTURED_LIVE
    ),
    ...
    CoverageRow(
        "kpi-tile-static", "KPI tile as a static label pair (no value slot)", Bucket.CAPTURED_LIVE
    ),
