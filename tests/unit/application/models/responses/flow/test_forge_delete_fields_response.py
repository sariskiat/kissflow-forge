"""Spec for app.application.models.responses.flow.forge_delete_fields_response."""
...
# `app.infrastructure.kissflow.client.DeleteFieldsReport.as_tool_result()`'s own
...
def _response(**overrides: object) -> ForgeDeleteFieldsResponse:
    base: dict[str, object] = {
        ...
        "deleted": ["A"],
        "surviving": [],
        "collateral": ["1 Permission node(s)"],
        "meta_version": "v2",
        "published": False,
    }
    base.update(overrides)
    return ForgeDeleteFieldsResponse.model_validate(base)
