"""Spec for app.application.use_cases.page._app_id.

Ports the app-id resolution refusal every page-scoped tool used to raise
through `server.py`'s `_client()` (`server.py:300-304`, common brief "The
app id"). One copy of this rule for the whole page family (CLAUDE.md >
lesson 14), shared by `forge_create_page`, `forge_build_page` and
